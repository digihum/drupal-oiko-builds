...
class CidocEntityHtmlRouteProvider extends AdminHtmlRouteProvider {
  ...
  protected function getCollectionRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('collection') && $entity_type->hasListBuilderClass()) {
      ...
      $route
        ...
        ->setRequirement('_permission', 'view cidoc entities')
  ...
  protected function getAddFormRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('add-form')) {
      ...
      $route
        ->setDefaults([
          '_controller' => 'Drupal\cidoc\Controller\CidocEntityAddController::addForm',
          '_title_callback' => 'Drupal\cidoc\Controller\CidocEntityAddController::getAddFormTitle',
        ])
  ...
  protected function getAddPageRoute(EntityTypeInterface $entity_type) {
    ...
    $route
      ->setDefaults([
        '_controller' => 'Drupal\cidoc\Controller\CidocEntityAddController::add',
