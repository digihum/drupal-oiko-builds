...
namespace Drupal\oiko_citation\Plugin\Field\FieldWidget;
 ...
 *
 * @FieldWidget(
 *   id = "entity_reference_citations",
 *   label = @Translation("Citations"),
 *   description = @Translation("A citations inline form widget."),
 *   field_types = {
 *     "entity_reference_revisions"
 *   }
 * )
 */
class InlineCitationsWidget extends WidgetBase {
  ...
  public function formMultipleElements(FieldItemListInterface $items, array &$form, FormStateInterface $form_state) {
    ...
    if ($real_item_count > 0) {
      $elements += array(
        '#theme' => 'oiko_citation_field_multiple_value_form',
  ...
  protected function initIsTranslating(FormStateInterface $form_state, EntityInterface $host) {
    ...
    if (($host instanceof ContentEntityInterface) && $host->isTranslatable() && $host->hasTranslation($form_state->get('langcode')) && $host->getTranslation($form_state->get('langcode'))->get($host->getEntityType()->getKey('default_langcode'))->value == 0) {
