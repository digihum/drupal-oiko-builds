...
class TipPluginTextExtended extends TipPluginText {
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $form['next_label'] = [
      ...
      '#description' => $this->t("This label will be used on the <em>previous</em> tour item as a link to move on to this item. It should describe the item you are editing on the current form.<br>If not specified a default value of 'Next: LABEL' will be used, where LABEL is the Label of this tour item."),
    ...
    $form['previous_label'] = [
      ...
      '#description' => $this->t('This label will be used on the <em>next</em> tour item as a link to move back to this item. It should describe the item you are editing on the current form.<br>If not specified a default value of \'‹ LABEL\' will be used, where LABEL is the Label of this tour item.'),
      '#default_value' => $this->get('previous_label'),
    ];
