...
class EDTFInfoLegacyTest extends PHPUnit_Framework_TestCase {
  ...
  public function testGetEDTFInfo($dateString, $valid, $min = NULL, $max = NULL) {
    ...
    if ($valid) {
      ...
      if (is_a($dateInfo,'\ComputerMinds\EDTF\EDTFInfoInterface')) {
        if (!is_null($min)) {
  ...
  public function dateStringProvider() {
    ...
    $valid_dates = array(
      ...
      array('19uu', '1900-01-01T00:00:00.000Z', '1999-12-31T23:59:59.999Z'),
      array('1999-uu', '1999-01-01T00:00:00.000Z', '1999-12-31T23:59:59.999Z'),
      array('1999-01-uu', '1999-01-01T00:00:00.000Z', '1999-01-31T23:59:59.999Z'),
      array('1999-uu-uu', '1999-01-01T00:00:00.000Z', '1999-12-31T23:59:59.999Z'),
